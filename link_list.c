...
/**
 * add_alias_end - Appends an alias node to the end of an alias_t linked list.
 ...
 *         On success, returns a pointer to the new node.
 */
alias_t *add_alias_end(alias_t **head, char *name, char *value)
{
 ...
 *
 * This function adds a new node with the provided directory path to the end
 * of the given list.
 *
...
/**
 * free_alias_list - Release memory occupied by an alias_t linked list.
 * @head: Pointer to the head of the alias_t list.
 */
void free_alias_list(alias_t *head)
{
...
/**
 * free_list - Release memory used by a list_t linked list.
 *
 * @head: Pointer to the head of the list_t list.
 */
void free_list(list_t *head)
